    ...
    return (
      <div className="text-center py-20">
        ...
        <button
          ...
          className="mt-4 text-sky-600 hover:text-sky-700 font-medium text-sm"
        >
          Back to Leads
        </button>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-start justify-between gap-4 mb-6">
              ...
              <span
                className={`inline-block px-3 py-1.5 rounded-full text-sm font-semibold ${currentStatus.color}`}
              >
                {currentStatus.label}
              </span>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-white border border-gray-200 flex items-center justify-center group-hover:border-sky-300 transition-colors">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900 truncate max-w-[180px]">{lead.email}</p>
                </div>
              </a>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {lead.services.map((service) => (
                <span
                  key={service}
                  className="inline-flex items-center gap-1.5 px-3 py-2 bg-sky-50 text-sky-700 rounded-lg text-sm font-medium"
                >
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-2">
              {STATUS_OPTIONS.map((status) => (
                <button
                  ...
                  className={`w-full px-4 py-3 rounded-lg text-sm font-medium transition-all border-2 flex items-center justify-between ${
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="space-y-2">
              <a
                href={`tel:${lead.phone}`}
                className="flex items-center justify-center gap-2 w-full bg-gray-900 hover:bg-gray-800 text-white py-3 rounded-lg font-medium text-sm transition-colors"
              >
              ...
              <a
                href={`mailto:${lead.email}`}
                className="flex items-center justify-center gap-2 w-full bg-sky-500 hover:bg-sky-600 text-white py-3 rounded-lg font-medium text-sm transition-colors"
              >
