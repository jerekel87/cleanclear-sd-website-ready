          ...
          <>
            ...
            <div className="grid grid-cols-7">
              {calendarDays.map((day, idx) => {
                if (day === null) {
                  return <div key={`empty-${idx}`} className="min-h-[160px] bg-slate-50/50 border-b border-r border-slate-100" />;
                }
                ...
                return (
                  <div
                    ...
                    className={`min-h-[160px] border-b border-r border-slate-100 p-1.5 cursor-pointer hover:bg-slate-50 transition-colors ${
